...
#
# Commands:
#   hubot help - Displays a URL that contains all of the help commands that Hubot knows about.
...
endpoint_url = process.env.HUBOT_ENDPOINT_URL
...
module.exports = (robot) ->
  robot.respond /help(?:\s+(.*))?$/i, (msg) ->
    ...
    if endpoint_url
      msg.send "#{endpoint_url}/#{robot.name.toLowerCase()}/help"
      return
